# Opens window with aerial view of the map.
"""
...
class World(object):
    ...
    def update_hud_info(self, clock):
        ...
        hero_mode_text = []
        if self.hero_actor is not None:
            print(self.hero_actor.get_control())
    ...
    def _parse_events(self):
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                #     print(type(self._world))
                #     print(self._world.actors_with_transforms)
                    x = self._world.world.get_vehicles_light_states()
                    print(x)
